package algorithm.a1datastructure;
...
public class Array {
    ...
    public static void main(String[] args) {
        ...
        Assert.assertArrayEquals(expectedArray01, array);

        // 数组插入(无顺序要求)
        int index2 = 4;
        String value2 = "11";
        insertArray02(array, index2, value2);
        Assert.assertArrayEquals(expectedArray02, array);

        // 数组删除(有顺序要求)
        int index3 = 5;
        deleteElement(array, index3);
        Assert.assertArrayEquals(expectedArray03, array);
        ...
        Assert.assertArrayEquals(expectedArray04, array);
        clearMark(array);
        Assert.assertArrayEquals(expectedArray05, array);
